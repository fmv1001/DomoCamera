...
\imagen{squse2}{Pantalla principal de SonarQube.}
\item
...
\imagen{ssuse1}{Cómo abrir un terminal desde una carpeta en Windows.}
\item 
...
\imagen{squse3}{Resumen del escaneo de SonarQube en la aplicación.}
...
\imagengrande{1.1}{sqpruebas1}{Actividad medida por SonarQube.}
...
\imagengrande{1}{sqpruebas5}{Resumen del proyecto en SonarQube.}
...
\imagengrande{1.1}{sqpruebas4}{Carpetas analizadas por SonarQube.}
